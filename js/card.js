...
(() => {
  ...
  const create = (object) => {
    ...
    cardTemplate.querySelector(`.popup__text--price`).textContent = (!object.offer.price) ? `` : cardTemplate.querySelector(`.popup__text--price`).textContent = `${object.offer.price}₽/ночь`;
    ...
    setHouseType(object.offer.type);
